namespace Lykke.OneSky.Json
{
    ...
    public interface IPlatformImportTask
    {
        ...
        /// </param>
        /// <returns>
        /// The <see cref="IOneSkyResponse{TMeta,TData}"/> with <see cref="IMeta"/> as <c>Meta</c> and list of <see cref="IImportTaskFile"/> as <c>Data</c>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The <see cref="IOneSkyResponse{TMeta,TData}"/> with <see cref="IMeta"/> as <c>Meta</c> and <see cref="IImportTaskFileInfo"/> as <c>Data</c>.
        /// </returns>
