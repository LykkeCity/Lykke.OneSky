namespace Lykke.OneSky.Json
{
    ...
    public interface IPlatformOrder
    {
        ...
        /// </param>
        /// <returns>
        /// The <see cref="IOneSkyResponse{TMeta,TData}"/> with <see cref="IMeta"/> as <c>Meta</c> and <see cref="IOrderPlatformDetails"/> as <c>Data</c>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The <see cref="IOneSkyResponse{TMeta,TData}"/> with <see cref="IMeta"/> as <c>Meta</c> and <see cref="IOrderPlatformNew"/> as <c>Data</c>.
        /// </returns>
