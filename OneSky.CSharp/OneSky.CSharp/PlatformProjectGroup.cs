namespace Lykke.OneSky
{
    internal class PlatformProjectGroup : IPlatformProjectGroup
    {
        ...
        private const string ProjectGroupShowAddress =
            "https://platform.api.onesky.io/1/project-groups/{project_group_id}";

        private const string ProjectGroupCreateAddress = "https://platform.api.onesky.io/1/project-groups";

        private const string ProjectGroupDeleteAddress =
            "https://platform.api.onesky.io/1/project-groups/{project_group_id}";

        private const string ProjectGroupLanguagesAddress =
            "https://platform.api.onesky.io/1/project-groups/{project_group_id}/languages";
